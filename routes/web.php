...
// Web middleware group (required for session and CSRF)
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        // Room routes - Redirect /room to /rooms for convenience
    ...
    // Fallback route - always return 404 for undefined routes
