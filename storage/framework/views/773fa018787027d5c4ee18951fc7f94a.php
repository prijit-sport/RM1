...
<div class="card mb-4 border-0 shadow-sm">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('facilities.index')); ?>" class="row g-3">
            <div class="col-md-3">
                <input type="text" name="search" class="form-control" placeholder="ค้นหาชื่อ/คำอธิบาย..." value="<?php echo e(request('search')); ?>">
            </div>
            <div class="col-md-2">
                <select name="type" class="form-select">
                    ...
                    <?php $__currentLoopData = $typeMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value); ?>" <?php echo e(request('type') == $value ? 'selected' : ''); ?>>
                            <?php echo e($info[0]); ?> <?php echo e($info[1]); ?>
                    ...
                    <tr>
                        <td class="ps-3">
                            <span class="badge <?php echo e($type[2]); ?> px-2 py-1">
                                <?php echo e($type[0]); ?> <?php echo e($type[1]); ?>
                        ...
                        <td>
                            <span class="badge <?php echo e($status[2]); ?> rounded-pill">
                                <?php echo e($status[0]); ?> <?php echo e($status[1]); ?>

                            </span>
                        </td>
                        <td><small><?php echo e($facility->last_maintenance_date ? \Carbon\Carbon::parse($facility->last_maintenance_date)->format('d/m/Y') : '-'); ?></small></td>
                        <td>
                            <?php if($nextDate): ?>
                                <span class="<?php echo e($isOverdue ? 'text-danger fw-bold' : ($isUpcoming ? 'text-warning' : '')); ?>">
                        ...
                        <td class="text-end pe-3">
                            <div class="btn-group">
                                <a href="<?php echo e(route('facilities.edit', $facility->id)); ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
                                <form action="<?php echo e(route('facilities.destroy', $facility->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('ยืนยันการลบ?')">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="text-muted small">
                <?php if($facilities->total() > 0): ?>
                    แสดง <?php echo e($facilities->firstItem()); ?> ถึง <?php echo e($facilities->lastItem()); ?> จาก <?php echo e($facilities->total()); ?> รายการ
                <?php endif; ?>
            </div>
            <div>
