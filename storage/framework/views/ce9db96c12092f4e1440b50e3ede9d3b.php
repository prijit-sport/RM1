...
<div class="container">
    ...
    <div class="page-header">
        <a href="<?php echo e(route('meters.index')); ?>" class="back-btn">←</a>
        <div>
    ...
    <div class="type-selector-card">
        ...
        <div class="type-buttons">
            <label class="type-btn" id="electric-btn">
                <input type="radio" name="type" value="electric" <?php echo e(old('type') == 'electric' ? 'checked' : ''); ?> onchange="setTypeActive()">
                <div class="type-icon">⚡</div>
                <div class="type-label">ไฟฟ้า</div>
            </label>
 
            <label class="type-btn" id="water-btn">
                <input type="radio" name="type" value="water" <?php echo e(old('type') == 'water' ? 'checked' : ''); ?> onchange="setTypeActive()">
                <div class="type-icon">💧</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('meters.store')); ?>" method="POST" id="meter-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <select id="room_id" name="room_id" class="form-control <?php $__errorArgs = ['room_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <?php $__currentLoopData = $rooms ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option value="<?php echo e($room->id); ?>" <?php echo e(old('room_id') == $room->id ? 'selected' : ''); ?>>
                                <?php echo e($room->room_number ?? '—'); ?> • <?php echo e($room->room_type ?? '—'); ?> (<?php echo e(number_format($room->price_per_month ?? 0, 2)); ?> ฿/เดือน)
                            </option>
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('meter_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('unit')); ?>" placeholder="เช่น kWh หรือ m³">
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('installed_at')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('rate_per_unit', 0)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('tax_rate', 0)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="is_active" name="is_active" class="form-control <?php $__errorArgs = ['is_active'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <option value="1" <?php echo e(old('is_active', '1') == '1' ? 'selected' : ''); ?>>✓ ใช้งาน</option>
                            <option value="0" <?php echo e(old('is_active') == '0' ? 'selected' : ''); ?>>✗ ระงับใช้งาน</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(route('meters.index')); ?>" class="btn btn-secondary btn-sm">ยกเลิก</a>
                </div>
            </form>
        </div>
...
<script>
 ...
 <?php /**PATH F:\xampp\htdocs\Rm1\resources\views/meters/create.blade.php ENDPATH**/ ?>