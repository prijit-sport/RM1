            ...
            <div class="d-flex align-items-center gap-3">
                                       ...
                                       class="notification-item">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">
                                                มีรายการซ่อมบำรุง <strong><?php echo e($pendingMaintenance); ?></strong> รายการที่รอดำเนินการ
                                            </small>
                                        </div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>"><i class="bi bi-person me-2"></i>โปรไฟล์</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('settings.edit')); ?>"><i class="bi bi-gear me-2"></i>ตั้งค่า</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
