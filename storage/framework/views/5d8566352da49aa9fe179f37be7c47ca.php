    ...
    <main class="main-content">
        ...
        <header class="topbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <!-- Notifications -->
                <div class="dropdown">
                    <button class="btn btn-light position-relative <?php echo e(($notificationCount ?? 0) > 0 ? 'notification-badge' : ''); ?>" data-bs-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <?php if(isset($notifications) && count($notifications) > 0): ?>
                            ...
                            <li><a class="dropdown-item" href="<?php echo e($notification['url'] ?? '#'); ?>"><?php echo e($notification['message']); ?></a></li>
