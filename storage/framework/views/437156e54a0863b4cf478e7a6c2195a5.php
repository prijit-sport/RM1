<?php $__env->startSection('title', 'เพิ่มมิเตอร์'); ?>

<?php $__env->startSection('page-title', 'เพิ่มมิเตอร์'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('meters.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="electric" <?php echo e(old('type') == 'electric' ? 'selected' : ''); ?>>ไฟฟ้า</option>
                                    <option value="water" <?php echo e(old('type') == 'water' ? 'selected' : ''); ?>>น้ำ</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('meter_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('unit')); ?>" placeholder="เช่น kWh หรือ m³">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('installed_at')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('rate_per_unit', 0)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tax_rate', 0)); ?>" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rm1\resources\views/meters/create.blade.php ENDPATH**/ ?>