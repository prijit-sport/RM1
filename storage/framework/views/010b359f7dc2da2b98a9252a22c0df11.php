...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $rooms ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option value="<?php echo e($room->id); ?>"
                                                <?php echo e(old('room_id', $meter->room_id) == $room->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="electric"
                                            <?php echo e(old('type', $meter->type) == 'electric' ? 'selected' : ''); ?>>ไฟฟ้า</option>
                                        <option value="water" <?php echo e(old('type', $meter->type) == 'water' ? 'selected' : ''); ?>>
                                            น้ำ</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="meter_number" type="text" name="meter_number"
                                        class="form-control <?php $__errorArgs = ['meter_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('meter_number', $meter->meter_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('unit', $meter->unit)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="installed_at" type="date" name="installed_at"
                                        class="form-control <?php $__errorArgs = ['installed_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('installed_at', optional($meter->installed_at)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('rate_per_unit', $meter->rate_per_unit)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('tax_rate', $meter->tax_rate)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="1"
                                            <?php echo e(old('is_active', $meter->is_active ? '1' : '0') == '1' ? 'selected' : ''); ?>>
                                            ใช้งาน</option>
                                        <option value="0"
                                            <?php echo e(old('is_active', $meter->is_active ? '1' : '0') == '0' ? 'selected' : ''); ?>>
                                            ระงับใช้งาน</option>
                                    </select>
