        ...
        <div class="col-md-6 col-lg-4">
            <div class="card report-stat-card h-100 p-3" style="background: linear-gradient(135deg, #fff 0%, #fff9e6 100%); border-left: 5px solid #ffc107;">
                <div class="card-body">
                    ...
                    <h2 class="display-6 fw-bold text-dark">฿<?php echo e(number_format($total_revenue, 2)); ?></h2>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card report-stat-card h-100 p-3" style="background: linear-gradient(135deg, #fff 0%, #eef6ff 100%); border-left: 5px solid #0dcaf0;">
                <div class="card-body">
                    ...
                    <h2 class="display-6 fw-bold text-dark"><?php echo e($occupancy_rate); ?>%</h2>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo e($occupancy_rate); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card report-stat-card h-100 p-3" style="background: linear-gradient(135deg, #fff 0%, #f0fff4 100%); border-left: 5px solid #198754;">
                <div class="card-body">
                    ...
                    <h2 class="display-6 fw-bold text-dark"><?php echo e($bookings_this_month); ?> <small class="fs-6 text-muted">รายการ</small></h2>
                    <p class="text-muted mb-0 small">จากทั้งหมด <?php echo e($total_bookings); ?> รายการ</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center fw-bold"><?php echo e($total_rooms); ?></td>
                                    <td style="width: 40%;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center fw-bold"><?php echo e($available_rooms); ?></td>
                                    <td>
                                        <div class="progress" style="height: 5px;"><div class="progress-bar bg-success" style="width: <?php echo e(($available_rooms/$total_rooms)*100); ?>%"></div></div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center fw-bold"><?php echo e($occupied_rooms); ?></td>
                                    <td>
                                        <div class="progress" style="height: 5px;"><div class="progress-bar bg-warning" style="width: <?php echo e(($occupied_rooms/$total_rooms)*100); ?>%"></div></div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center fw-bold"><?php echo e($maintenance_rooms); ?></td>
                                    <td>
                                        <div class="progress" style="height: 5px;"><div class="progress-bar bg-danger" style="width: <?php echo e(($maintenance_rooms/$total_rooms)*100); ?>%"></div></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3 pb-3 border-bottom">
                        ...
                        <span class="fw-bold"><?php echo e($pending_bookings); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-3 pb-3 border-bottom">
                        <div class="d-flex align-items-center">
                        ...
                        <span class="fw-bold"><?php echo e($confirmed_bookings); ?></span>
                    </div>
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-bold"><?php echo e($cancelled); ?></span>
                    </div>
                </div>
                <div class="card-footer bg-light border-0 py-3 text-center">
                    <small class="text-muted">รวมรายการจองทั้งหมด <?php echo e($total_bookings); ?> รายการ</small>
                </div>
            </div>
        </div>
    </div>
