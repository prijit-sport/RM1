...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('rooms.bulk-create')); ?>" class="btn btn-outline-primary">เพิ่มหลายห้อง</a>
        <a href="<?php echo e(route('rooms.create')); ?>" class="btn btn-primary">เพิ่มห้องใหม่</a>
    </div>
</div>
...
<div class="card search-card mb-4">
    <div class="card-body p-3">
        <form action="<?php echo e(route('rooms.index')); ?>" method="GET" class="row g-2">
            <div class="col-md-5">
                <div class="input-group">
                    <span class="input-group-text bg-transparent border-end-0"><i class="bi bi-search"></i></span>
                    <input type="text" name="search" class="form-control border-start-0" placeholder="พิมพ์หมายเลขห้องเพื่อค้นหา..." value="<?php echo e(request('search')); ?>">
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                <div class="d-flex gap-2">
                    ...
                    <?php if(request()->has('search') || request()->has('status')): ?>
                        <a href="<?php echo e(route('rooms.index')); ?>" class="btn btn-light border">ล้าง</a>
                    <?php endif; ?>
                </div>
            </div>
        </form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <span class="badge bg-<?php echo e($badgeClass); ?> bg-opacity-10 text-<?php echo e($badgeClass); ?>">
                            <?php echo e($statusText); ?>

                        </span>
                    </td>
                    <td class="text-end pe-4">
                        <a href="<?php echo e(route('rooms.show', $room)); ?>" class="btn btn-sm btn-light text-info"><i class="bi bi-eye"></i></a>
                        <a href="<?php echo e(route('rooms.edit', $room)); ?>" class="btn btn-sm btn-light text-warning"><i class="bi bi-pencil"></i></a>
                    </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rm1\resources\views/rooms/index.blade.php ENDPATH**/ ?>