            ...
            <div class="alert alert-info border-0 d-flex align-items-center mb-4" role="alert">
                ...
                <div>
                    <?php if(request('room_id')): ?>
                        <?php $preRoom = $rooms->firstWhere('id', request('room_id')); ?>
                        <?php if($preRoom): ?>
                            ระบบได้เลือกห้อง <strong>#<?php echo e($preRoom->room_number); ?></strong>
                            <?php if($preRoom->zone): ?>
                                (โซน <?php echo e($preRoom->zone); ?>)
                            <?php endif; ?>
                    ...
                    <?php elseif(request('room_type')): ?>
                        กำลังจอง: <strong><?php echo e(request('room_type') === 'fan' ? '🌀 ห้องพัดลม' : '❄️ ห้องแอร์'); ?></strong>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $guests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($guest->id); ?>"
                                        <?php echo e(old('guest_id') == $guest->id ? 'selected' : ''); ?>>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="zone_select" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $rooms->pluck('zone')->filter()->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($zone); ?>">โซน <?php echo e($zone); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="0" min="0" value="<?php echo e(old('electric_meter_start', 0)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="0" min="0" value="<?php echo e(old('water_meter_start', 0)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="confirmed"
                                        <?php echo e(old('status', 'confirmed') == 'confirmed' ? 'selected' : ''); ?>>
                                        ยืนยันแล้ว
                                    </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-0">
                                ...
                                <textarea name="notes" class="form-control" rows="3" placeholder="บันทึกเพิ่มเติม..."><?php echo e(old('notes')); ?></textarea>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\Rm1\resources\views/bookings/create.blade.php ENDPATH**/ ?>