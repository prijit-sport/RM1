...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" autocomplete="username" required>
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" autocomplete="current-password" required>
...
<?php /**PATH C:\xampp\htdocs\Rm1\resources\views/auth/login.blade.php ENDPATH**/ ?>