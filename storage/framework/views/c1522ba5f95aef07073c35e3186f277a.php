...
<head>
    ...
    <?php if(file_exists(public_path('css/romar-theme.css'))): ?>
        <link rel="stylesheet"
            href="<?php echo e(asset('css/romar-theme.css?v=' . filemtime(public_path('css/romar-theme.css')))); ?>">
    <?php endif; ?>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            <a href="<?php echo e(route('dashboard')); ?>"
                class="sidebar-menu-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                <i class="bi bi-speedometer2"></i>
                <span>แดชบอร์ด</span>
            </a>

            <a href="<?php echo e(route('rooms.index')); ?>"
                class="sidebar-menu-item <?php echo e(request()->routeIs('rooms.*') ? 'active' : ''); ?>">
                <i class="bi bi-door-open"></i>
                <span>ห้องพัก</span>
            </a>

            <a href="<?php echo e(route('guests.index')); ?>"
                class="sidebar-menu-item <?php echo e(request()->routeIs('guests.*') ? 'active' : ''); ?>">
            ...
            <?php if(auth()->check() && auth()->user() && auth()->user()->hasRole('Admin')): ?>
                <a href="<?php echo e(route('contracts.index')); ?>"
                    class="sidebar-menu-item <?php echo e(request()->routeIs('contracts.*') ? 'active' : ''); ?>">
                    <i class="bi bi-file-earmark-text"></i>
                    <span>สัญญาเช่า</span>
                </a>

                <a href="<?php echo e(route('invoices.index')); ?>"
                    class="sidebar-menu-item <?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('meters.index')); ?>"
                    class="sidebar-menu-item <?php echo e(request()->routeIs('meters.*') ? 'active' : ''); ?>">
                    <i class="bi bi-lightning-charge"></i>
                    <span>มิเตอร์น้ำ/ไฟ</span>
                </a>

                <a href="<?php echo e(route('maintenances.index')); ?>"
                    class="sidebar-menu-item <?php echo e(request()->routeIs('maintenances.*') ? 'active' : ''); ?>">
                    <i class="bi bi-tools"></i>
                    <span>ซ่อมบำรุง</span>
                    <?php if(isset($pendingMaintenance) && $pendingMaintenance > 0): ?>
                        <span class="badge bg-warning ms-auto"><?php echo e($pendingMaintenance); ?></span>
                    <?php endif; ?>
                </a>

                <a href="<?php echo e(route('facilities.index')); ?>"
                    class="sidebar-menu-item <?php echo e(request()->routeIs('facilities.*') ? 'active' : ''); ?>">
                    <i class="bi bi-building"></i>
                    <span>สิ่งอำนวยความสะดวก</span>
                </a>

                <a href="<?php echo e(route('roles.index')); ?>"
                    class="sidebar-menu-item <?php echo e(request()->routeIs('roles.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('reports.index')); ?>"
                class="sidebar-menu-item <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
    ...
    <main class="main-content">
        ...
        <header class="topbar">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button
                        class="btn btn-light position-relative <?php echo e($totalNotifications > 0 ? 'notification-badge' : ''); ?>"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end notification-dropdown">
                        <li>
                            <div class="notification-header">
                                ...
                                <?php if($totalNotifications > 0): ?>
                                    <span class="badge bg-light text-dark"><?php echo e($totalNotifications); ?> รายการ</span>
                                <?php endif; ?>
                            </div>
                        </li>
                        ...
                        <?php else: ?>
                                    ...
                                    <a href="<?php echo e(route('maintenances.index', ['status' => 'pending'])); ?>"
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">
                                                มีรายการซ่อมบำรุง <strong><?php echo e($pendingMaintenance); ?></strong>
                            ...
                            <?php if($pendingPayments > 0): ?>
                                <li>
                                    <a href="<?php echo e(route('invoices.index')); ?>" class="notification-item">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">
                                                มีใบแจ้งหนี้ <strong><?php echo e($pendingPayments); ?></strong> ใบที่ยังไม่ชำระ
                                            </small>
                                        </div>
                                        <i class="bi bi-chevron-right text-muted"></i>
                                    </a>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text">
                                <small class="text-muted"><?php echo e(auth()->user()->role->name ?? 'User'); ?></small>
                            </span></li>
                        <li>
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('settings.edit')); ?>"><i
...
<?php /**PATH F:\xampp\htdocs\Rm1\resources\views/layouts/app.blade.php ENDPATH**/ ?>