...
<div class="container">
    ...
    <div class="card">
        <div class="card-title">📅 รายละเอียดการจอง #<?php echo e($booking->id); ?></div>
        ...
        <div class="info-group">
            <div class="info-item highlight">
                ...
                <div class="info-value">
                    ...
                    (<?php echo e($booking->room->room_type ?? '-'); ?>)
                </div>
            </div>
            ...
            <div class="info-item">
                ...
                <div class="info-value">
                    <?php echo e($booking->check_in_date ? \Carbon\Carbon::parse($booking->check_in_date)->format('d/m/Y') : '-'); ?>
            ...
            <div class="info-item">
                ...
                <span class="status <?php echo e($booking->status); ?>">
            ...
            <div class="info-item">
                ...
                <div class="info-value">฿<?php echo e(number_format($booking->rent_amount ?? 0, 2)); ?></div>
            </div>
 
            <div class="info-item">
                <div class="info-label">เงินมัดจำ</div>
                <div class="info-value">฿<?php echo e(number_format($booking->deposit_amount ?? 0, 2)); ?></div>
            </div>
 
            <div class="info-item">
                <div class="info-label">⚡ มิเตอร์ไฟเริ่มต้น</div>
                <div class="info-value"><?php echo e($booking->electric_meter_start ?? 0); ?> หน่วย</div>
            </div>
 
            <div class="info-item">
                <div class="info-label">💧 มิเตอร์น้ำเริ่มต้น</div>
                <div class="info-value"><?php echo e($booking->water_meter_start ?? 0); ?> หน่วย</div>
            </div>
 
            <div class="info-item">
                <div class="info-label">สร้างเมื่อ</div>
                <div class="info-value"><?php echo e($booking->created_at->format('d/m/Y H:i')); ?></div>
            </div>
        </div>
        ...
        <div class="btn-group">
            ...
            <a href="<?php echo e(route('bookings.edit', $booking)); ?>" class="btn btn-primary">✏️ แก้ไข</a>
            <a href="<?php echo e(route('bookings.index')); ?>" class="btn btn-secondary">← กลับ</a>
        ...
        <form action="<?php echo e(route('bookings.confirm', $booking)); ?>" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="meter-info-box">
                    <strong>ห้อง <?php echo e($booking->room?->room_number); ?>

                        | <?php echo e($booking->guest?->first_name); ?> <?php echo e($booking->guest?->last_name); ?></strong>
                    มิเตอร์ไฟเริ่มต้น: <strong><?php echo e($booking->electric_meter_start ?? 0); ?></strong> หน่วย
                    &nbsp;|&nbsp;
                    มิเตอร์น้ำเริ่มต้น: <strong><?php echo e($booking->water_meter_start ?? 0); ?></strong> หน่วย
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" name="electric_rate"
                               ...
                               value="<?php echo e(old('electric_rate', 7.00)); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" name="water_rate"
                               ...
                               value="<?php echo e(old('water_rate', 18.00)); ?>" required>
                        <span class="input-group-text">฿ / หน่วย</span>
                    </div>
                </div>
...
<?php endif; ?>
 ...
 <?php /**PATH C:\xampp\htdocs\Rm1\resources\views/bookings/show.blade.php ENDPATH**/ ?>