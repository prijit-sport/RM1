...
| เลขมิเตอร์: <strong><?php echo e($meter->meter_number); ?></strong>
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?php echo e(route('meters.readings.export', $meter) . '?' . http_build_query(request()->only(['date', 'search']))); ?>" class="btn btn-success">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('meters.readings.index', $meter)); ?>" class="row g-3">
            ...
            <div class="col-md-4">
                <input type="text" name="search" class="form-control" placeholder="ค้นหา..." value="<?php echo e(request('search')); ?>">
            </div>
            <div class="col-md-2">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $readings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('meters.readings.edit', [$meter, $reading])); ?>" class="btn btn-sm btn-outline-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="<?php echo e(route('meters.readings.destroy', [$meter, $reading])); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('ยืนยันการลบรายการ?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rm1\resources\views/meter_readings/index.blade.php ENDPATH**/ ?>