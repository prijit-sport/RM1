...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('invoice_number', $invoiceNumber ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tax')); ?>" required>
                                <?php $__errorArgs = ['tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('total')); ?>" required readonly>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="sent" <?php echo e(old('status') === 'sent' ? 'selected' : ''); ?>>ส่งแล้ว</option>
                                    <option value="paid" <?php echo e(old('status') === 'paid' ? 'selected' : ''); ?>>ชำระแล้ว</option>
                                    <option value="overdue" <?php echo e(old('status') === 'overdue' ? 'selected' : ''); ?>>เกินกำหนด</option>
