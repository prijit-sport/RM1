        ...
        <div class="card">
            ...
            <form action="{{ route('meters.readings.store', $meter) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="reading_date" name="reading_date" type="date" value="{{ old('reading_date') }}" required>
                    @error('reading_date') <div class="error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="reading_value">เลขมิเตอร์ *</label>
                    <input id="reading_value" name="reading_value" type="number" step="0.01" min="0" value="{{ old('reading_value') }}" placeholder="เช่น 1234.00" required>
