    ...
    <div class="col-12">
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">เพิ่มสัญญาใหม่</li>
            </ol>
        </nav>

        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">
                <i class="bi bi-file-earmark-plus me-2"></i>เพิ่มสัญญาเช่าใหม่
            </h4>
        </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('contracts.store') }}">
                    ...
                    <h6 class="text-muted mb-3 border-bottom pb-2">
                        <i class="bi bi-file-text me-1"></i>ข้อมูลพื้นฐาน
                    </h6>
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required placeholder="เช่น สัญญาเช่าห้องพักรายเดือน">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" id="contract_date" name="contract_date" class="form-control @error('contract_date') is-invalid @enderror" value="{{ old('contract_date') }}">
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <select id="guest_id" name="guest_id" class="form-select @error('guest_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($guests as $guest)
                                        <option value="{{ $guest->id }}" {{ old('guest_id') == $guest->id ? 'selected' : '' }}>{{ $guest->first_name }} {{ $guest->last_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <h6 class="text-muted mb-3 border-bottom pb-2 mt-4">
                        <i class="bi bi-person-badge me-1"></i>ข้อมูลผู้ให้เช่า
                    </h6>
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-person"></i></span>
                                <input type="text" id="landlord_name" name="landlord_name" class="form-control @error('landlord_name') is-invalid @enderror" value="{{ old('landlord_name') }}" placeholder="ชื่อ-นามสกุลผู้ให้เช่า">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="landlord_address" name="landlord_address" class="form-control @error('landlord_address') is-invalid @enderror" value="{{ old('landlord_address') }}" placeholder="ที่อยู่ผู้ให้เช่า">
                            </div>
                    ...
                    <h6 class="text-muted mb-3 border-bottom pb-2 mt-4">
                        <i class="bi bi-calendar-range me-1"></i>ระยะเวลาสัญญา
                    </h6>
                    <div class="row g-3">
                        <div class="col-md-6">
                    ...
                    <h6 class="text-muted mb-3 border-bottom pb-2 mt-4">
                        <i class="bi bi-cash me-1"></i>รายละเอียดค่าใช้จ่าย
                    </h6>
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="monthly_rent" name="monthly_rent" class="form-control @error('monthly_rent') is-invalid @enderror" value="{{ old('monthly_rent') }}" step="0.01" required placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="deposit" name="deposit" class="form-control @error('deposit') is-invalid @enderror" value="{{ old('deposit') }}" step="0.01" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="advance_payment" name="advance_payment" class="form-control @error('advance_payment') is-invalid @enderror" value="{{ old('advance_payment') }}" step="0.01" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="electricity_rate" name="electricity_rate" class="form-control @error('electricity_rate') is-invalid @enderror" value="{{ old('electricity_rate') }}" step="0.01" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="water_rate" name="water_rate" class="form-control @error('water_rate') is-invalid @enderror" value="{{ old('water_rate') }}" step="0.01" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="late_fee" name="late_fee" class="form-control @error('late_fee') is-invalid @enderror" value="{{ old('late_fee') }}" step="0.01" placeholder="0.00">
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="other_fees" name="other_fees" class="form-control @error('other_fees') is-invalid @enderror" value="{{ old('other_fees') }}" placeholder="รายละเอียดค่าใช้จ่ายอื่นๆ">
                            @error('other_fees')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                    </div>

                    <h6 class="text-muted mb-3 border-bottom pb-2 mt-4">
                        <i class="bi bi-file-earmark-text me-1"></i>ข้อตกลง
                    </h6>
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="terms" class="form-label">ข้อตกลงและเงื่อนไข</label>
                            <textarea id="terms" name="terms" class="form-control @error('terms') is-invalid @enderror" rows="4" placeholder="กรุณากรอกข้อตกลงและเงื่อนไขสัญญา">{{ old('terms') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="draft" {{ old('status') === 'draft' ? 'selected' : '' }}>ร่างสัญญา</option>
                    ...
                    <h6 class="text-muted mb-3 border-bottom pb-2 mt-4">
                        <i class="bi bi-card-text me-1"></i>หมายเหตุ
                    </h6>
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="description" class="form-label">คำอธิบาย/รายละเอียด</label>
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="กรุณากรอกรายละเอียดสัญญา">{{ old('description') }}</textarea>
                            @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-12">
                            <label for="notes" class="form-label">หมายเหตุ</label>
                            <textarea id="notes" name="notes" class="form-control @error('notes') is-invalid @enderror" rows="2" placeholder="กรุณากรอกหมายเหตุ">{{ old('notes') }}</textarea>
