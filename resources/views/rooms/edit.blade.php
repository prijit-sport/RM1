                    ...
                    <form action="{{ route('rooms.update', $room->id) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price_per_month" class="form-control @error('price_per_month') is-invalid @enderror" value="{{ old('price_per_month', $room->price_per_month) }}" required min="0">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="floor" class="form-control @error('floor') is-invalid @enderror" value="{{ old('floor', $room->floor) }}" required min="1">
                                @error('floor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
