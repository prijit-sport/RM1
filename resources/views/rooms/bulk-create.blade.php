                        ...
                        <tbody>
                            ...
                            @foreach ($oldRooms as $i => $room)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-select room-type" name="rooms[{{ $i }}][room_type]"
                                            ...
                                            <option value="fan" @selected(($room['room_type'] ?? '') === 'fan')>
                                                {{ enum_bi('room_type', 'fan') }}</option>
                                            <option value="air" @selected(($room['room_type'] ?? '') === 'air')>
                                                {{ enum_bi('room_type', 'air') }}</option>
                                        </select>
                                    </td>
                                    <td><input type="number" min="0" step="0.01" class="form-control room-price"
                                            name="rooms[{{ $i }}][price_per_month]"
                                            data-room-index="{{ $i }}"
                                            value="{{ $room['price_per_month'] ?? '' }}" required></td>
                                    <td><input type="number" min="1" class="form-control"
                                            name="rooms[{{ $i }}][capacity]"
                                            value="{{ $room['capacity'] ?? 1 }}" required></td>
                                    <td>
                                    ...
                                    <td><input type="number" min="1" class="form-control"
                                            name="rooms[{{ $i }}][floor]" value="{{ $room['floor'] ?? 1 }}"
                                            required></td>
                                    <td><input type="text" class="form-control"
...
<option value="air">{{ enum_bi('room_type', 'air') }}</option>
                        </select>
                    </td>
