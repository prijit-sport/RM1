...
@section('title', 'แก้ไขมิเตอร์')

@section('page-title', 'แก้ไขมิเตอร์')
                    ...
                    <form action="{{ route('meters.update', $meter) }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <select id="type" name="type" class="form-select @error('type') is-invalid @enderror" required>
                                    ...
                                    <option value="electric" {{ old('type', $meter->type) == 'electric' ? 'selected' : '' }}>ไฟฟ้า</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="meter_number" type="text" name="meter_number" class="form-control @error('meter_number') is-invalid @enderror" value="{{ old('meter_number', $meter->meter_number) }}" required>
                                @error('meter_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input id="unit" type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{ old('unit', $meter->unit) }}">
                                @error('unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input id="installed_at" type="date" name="installed_at" class="form-control @error('installed_at') is-invalid @enderror" value="{{ old('installed_at', optional($meter->installed_at)->format('Y-m-d')) }}">
                                @error('installed_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input id="rate_per_unit" type="number" step="0.01" name="rate_per_unit" class="form-control @error('rate_per_unit') is-invalid @enderror" value="{{ old('rate_per_unit', $meter->rate_per_unit) }}" required>
                                @error('rate_per_unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input id="tax_rate" type="number" step="0.01" name="tax_rate" class="form-control @error('tax_rate') is-invalid @enderror" value="{{ old('tax_rate', $meter->tax_rate) }}" required>
                                @error('tax_rate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <select id="is_active" name="is_active" class="form-select @error('is_active') is-invalid @enderror">
                                    <option value="1" {{ old('is_active', $meter->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>ใช้งาน</option>
                                    <option value="0" {{ old('is_active', $meter->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>ระงับใช้งาน</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="notes" name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3">{{ old('notes', $meter->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
